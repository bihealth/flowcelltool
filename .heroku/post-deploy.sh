...
echo "from django.contrib.auth import get_user_model; User = get_user_model(); User.objects.create_superuser('root', 'admin@example.com', '$FLOWCELLTOOL_INITIAL_ROOT_PASSWORD')" \
...
>&2 echo ""
>&2 echo "LOGIN:    'root'"
>&2 echo "PASSWORD: '$FLOWCELLTOOL_INITIAL_ROOT_PASSWORD'"
>&2 echo ""
>&2 echo "================================================"
