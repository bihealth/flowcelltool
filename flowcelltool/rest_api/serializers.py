...
class SequencingMachineSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields = ('pk', 'url', 'created', 'modified', 'vendor_id', 'label',
...
class BarcodeSetSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields = ('pk', 'url', 'created', 'modified', 'name', 'short_name',
                  'description', 'entries')
...
class BarcodeSetEntrySerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields = ('pk', 'url', 'created', 'modified', 'name', 'sequence',
                  'barcode_set')
...
class FlowCellSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields = ('pk', 'url', 'created', 'modified', 'owner', 'name',
...
class LibrarySerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields = ('pk', 'url', 'created', 'modified', 'name', 'reference',
...
class MessageSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields = ('pk', 'url', 'created', 'modified', 'title', 'body',
