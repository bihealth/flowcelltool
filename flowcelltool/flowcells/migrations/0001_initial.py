    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('barcode_set', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entries', to='flowcells.BarcodeSet')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='Short description of the flow cell <a href="http://daringfireball.net/projects/markdown/syntax" target="_blank">Markdown syntax</a> allowed, but no raw HTML. Examples: **bold**, *italic*, indent 4 spaces for a code block.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('barcode', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='flowcells.BarcodeSetEntry')),
                ('barcode2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='barcodes2', to='flowcells.BarcodeSetEntry')),
                ('barcode_set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='flowcells.BarcodeSet')),
                ('barcode_set2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='barcode_sets2', to='flowcells.BarcodeSet')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='Short description of the machine. <a href="http://daringfireball.net/projects/markdown/syntax" target="_blank">Markdown syntax</a> allowed, but no raw HTML. Examples: **bold**, *italic*, indent 4 spaces for a code block.', null=True)),
