# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-10-02 12:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('barcode', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='flowcells.BarcodeSetEntry')),
                ('barcode_set', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='flowcells.BarcodeSet')),
